...
<center>
          <table border='0'>
               ...
               <tr>
                    ...
                    <td><input class="rad" classtype="text" name="lat" id="lat" value="<?php echo $_SESSION['lat']; ?>">
                    </td>
                    
                    <td>Longitude
                    </td>
                    <td><input class="rad" classtype="text" name="longt" id="longt"  value="<?php echo $_SESSION['longt']; ?>">
                    </td>
                    </tr>
